function setGestures(){
	...
	flexCars.setGestureRecognizer(1, {fingers:1,taps:2}, doubleTapGestureHandler);
	...
	flexCars.setGestureRecognizer(2, {fingers:1,swipedistance:50,swipevelocity:75}, swipeGestureHandler);
	...
	flexCars.setGestureRecognizer(3, {pressDuration:2}, longPressGestureHandler);
}
